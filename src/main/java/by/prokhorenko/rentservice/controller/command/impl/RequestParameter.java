...
public class RequestParameter {
    ...
    public static final String ADVERTISEMENT_FLAT_LOCATION_CITY = "city";
    public static final String ADVERTISEMENT_FLAT_LOCATION_DISTRICT = "district";
    public static final String ADVERTISEMENT_FLAT_LOCATION_STREET = "street";
    ...
    public static final String ADVERTISEMENT_FLAT_DESCRIPTION_PETS = "pets";
    public static final String ADVERTISEMENT_FLAT_DESCRIPTION_INTERNET = "internet";
    public static final String ADVERTISEMENT_FLAT_DESCRIPTION_USERS_DESCRIPTION = "usersDescription";
