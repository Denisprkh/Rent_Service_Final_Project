...
public class AllAdvertisementsPageCommand implements Command {
    ...
    public Router execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            session.setAttribute(Attribute.ADMIN_ALL_ADVERTISEMENTS_LIST,allAdvertisementList);
        } catch (ServiceException e) {
            LOG.error(e);
        }
        return new Router(DisPathType.FORWARD,PagePath.ALL_ADVERTISEMENTS_PAGE);
    }
}
