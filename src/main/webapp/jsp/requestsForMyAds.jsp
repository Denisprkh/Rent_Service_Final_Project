...
<html>
<head>
    <title><fmt:message key="profile.requests_for_my_ads"/></title>
...
<div class="container">
    ...
    <div class="all_ads_handler">
        <div class="formyads">
            <c:choose>
                <c:when test="${empty requestsOnUsersAdvertisementsList}">
                    <div class="info_text">
                        <fmt:message key="profile.requests_for_my_ads_no_requests_info"/>
                    </div>
                </c:when>
                <c:otherwise>
