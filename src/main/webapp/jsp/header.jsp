        ...
        <div class="header_items">
            ...
            <div class="header_btn">
                <div class="header_signin btnt">
                    <a href="${pageContext.request.contextPath}/controller?command=signInPage"><fmt:message
                            key="nav_bar.sign_in"/></a>
                </div>
                <div class="header_register btnt">
                    <a href="${pageContext.request.contextPath}/controller?command=signUpPage"><fmt:message
                            key="nav_bar.sign_up"/></a>
                </div>
                </c:if>
