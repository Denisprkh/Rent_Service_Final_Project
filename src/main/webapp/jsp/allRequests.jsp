        ...
        <div class="card-page">
            <c:if test="${currentPage != 1 && pagesQuantity > 0}">
                <div class="prevision_page bgc-page">
                    ...
                    <div class="prev-text">
                        <a href="${pageContext.request.contextPath}/controller?command=ALL_REQUESTS_PAGE&currentPage=${currentPage-1}">Previous
                            page</a>
                    </div>
                </div>
            </c:if>
            ...
            <c:if test="${currentPage ne pagesQuantity && pagesQuantity > 0}">
                <div class="next-page bgc-page">
                    <div class="next-page-text">
                        <a href="${pageContext.request.contextPath}/controller?command=ALL_REQUESTS_PAGE&currentPage=${currentPage+1}">Next
                            page</a>
                    </div>
                    <div class="icon">
